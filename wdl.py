...
W O R D L I S T # G E N E R A T O R # J 4 C K O P T O O L S\033[0m
...
print wgen_banner
print '\033[1;32mtekan 1\nuntuk mulai membuat wordlist\033[0m'
print '\n\033[1;37mtekan "2" untuk dapatkan menu bantuan\033[0m'
...
Menu Bantuan WGen:
	...
	keluar keluar dari program\031[0m
...
while opt:
	...
	wgen=raw_input('\033[1;31mWGen' + interpreter + ' ')
	...
	if wgen == '2':
		...
		try:
			...
			j=raw_input("WGen?> Nama Pacar : ")

			k=raw_input("WGen?> Tanggal Jadian (ex: DDMMYY): ")
			...
			print " \n[+] Selesai. Kumpulan kata disimpan sebagai %s1.txt\n" %a
